package net.mcreator.messinaround;
...
import net.mcreator.messinaround.init.MessinaroundModTabs;
...
@Mod("messinaround")
public class MessinaroundMod {
	public static final Logger LOGGER = LogManager.getLogger(MessinaroundMod.class);
	public static final String MODID = "messinaround";

	public MessinaroundMod(IEventBus modEventBus) {
